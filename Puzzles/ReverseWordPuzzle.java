...
public class ReverseWordPuzzle extends AbstractWordPuzzle {
	...
	public ReverseWordPuzzle(String puzzleWord) {
		// COMPLETE THIS
		super.setPuzzleWord(puzzleWord);
	}
	...
	public String getSolution() {
		// COMPLETE THIS
		String puzzleWord = super.getPuzzleWord();
		ArrayList<Character> rl = new ArrayList<Character>();
		for (int i = puzzleWord.length() - 1; i >= 0; i--) {
			rl.add(puzzleWord.charAt(i));
		}
